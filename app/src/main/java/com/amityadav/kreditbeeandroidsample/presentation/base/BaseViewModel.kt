...
import com.amityadav.kreditbeeandroidsample.presentation.livedata.*
import com.amityadav.kreditbeeandroidsample.presentation.livedata.*
...
open class BaseViewModel : ViewModel(), IBaseViewModel, LifecycleObserver {
    ...
    fun checkForEmptyString(string: String?) : Boolean {
    ...
    fun compareString(string1: String?, string2: String?) : Boolean {
        if(string1 == string2) {
            return true
        }
        return false
