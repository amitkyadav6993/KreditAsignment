...
class PhotoViewModel constructor(private val networkManagerImpl: NetworkManagerImpl,
    ...
    fun fetchPhotoListData(id: String?, limit: Int, offset: Int) {
        networkManagerImpl.getPhotosById(viewModelScope, id, limit, offset, object : ApiResponse<Any> {
    ...
    fun getPhotoListData(): MutableLiveData<ViewModelResponse> {
